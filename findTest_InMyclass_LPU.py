# Program to LOGIN into the myclass lovelyprofessionaluniversity portal and see if there is any test or not.
...
#10 - this is the link of the box or tab from the home page afterloggin in into the portal
# with the help of it we can see weather there is any test or not.
testURL = "https://lovelyprofessionaluniversity.codetantra.com/secure/home/tests.jsp"
driver.get(testURL)
